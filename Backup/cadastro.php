...
<form method="post" action="Cadastrausuario.php" >
  <div class="row">
    ...
    <div class="col">
      ...
      <input  style="margin: 0 20;" type="text" class="form-control" name="idade" placeholder="Dia">
    </div>
    ...
    <div class="col">
     ...
     <div class="col">
      ...
      <input style="margin: 20 20;" type="text" class="form-control" name="senha" placeholder="Senha">
          ...
          <div class="row">
    <input style="margin-left: 50px;margin-top: 80px" name="submit" type="submit" value="Enviar" id="1744164126">
  </div>
  </form>
