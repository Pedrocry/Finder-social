      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" >
        ...
        <div class="carousel-inner" > <!-- style="height: 300px" -->
          <div class="carousel-item active">
            ...
            <div class="container">
              <img class="" src="mig.jpg" height="100%" width="100%" alt="Second slide">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="mig.jpg" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="mig.jpg" alt="Third slide">
            <div class="container">
      ...
      <div class="container marketing">
        ...
        <div class="row">
          ...
          include 'BD.php';
            ...
            echo " ".$value['estv'].",".$value['interesse']." ".$value['idade']."<p>  <p><a class='btn btn-secondary' href='#' role=button'>View details &raquo;</a></p>
          </div></a>";
             }
            ?>
